...
namespace WebApp_KetNoiViecLam.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(WebApp_KetNoiViecLamContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CatId,CatName,Level,ParentId,MenuOrder,IsActive")] Category category)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApp_KetNoiViecLamContext.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
