...
if ($('.thumbimg-countnumber-carousel').length) {
  var myCarousel = $('.thumbimg-countnumber-carousel');
  var singleItem = '.slider-slide-item';
  var nextBtn = $('.slider-navigation-btn .left-btn');
  var prevBtn = $('.slider-navigation-btn .right-btn');
  var textCountWrap = $('.slider-number-count');
...
if($('.slider-1-grid').length){
  $('.slider-1-grid').owlCarousel({
    loop:true,
    margin:30,
    center:false,
    dots:true,
...
if($('.slider-2-grid').length){
  $('.slider-2-grid').owlCarousel({
    loop:true,
    margin:30,
    center:false,
    dots:true,
...
/*  Shop-Item-3-Grid-Slider-Owl-carousel  */
if($('.slider-3-grid').length){
  $('.slider-3-grid').owlCarousel({
    loop:true,
    margin:30,
    center:false,
    dots:true,
...
/*  Shop-Item-4-Grid-Slider-Owl-carousel  */
if($('.slider-4-grid2').length){
  $('.slider-4-grid2').owlCarousel({
    loop:true,
    margin:30,
    center:false,
    dots:true,
...
if($('.slider-5-grid').length){
  $('.slider-5-grid').owlCarousel({
    loop:true,
    margin:30,
    dots:true,
    nav:true,
...
if($('.slider-6-grid').length){
  $('.slider-6-grid').owlCarousel({
    loop:true,
    margin:30,
    center:false,
    dots:true,
...
if($('.slider-7-grid').length){
  $('.slider-7-grid').owlCarousel({
    loop:true,
    margin:28,
    center:false,
    dots:true,
...
/*  Shop-Item-7-Grid-Slider-Owl-carousel  */
if($('.slider-8-grid').length){
  $('.slider-8-grid').owlCarousel({
    loop:true,
    margin:0,
    center:false,
    dots:true,
...
if($('.slider-10-grid').length){
  $('.slider-10-grid').owlCarousel({
    loop:true,
    margin:0,
    center:false,
    dots:true,
